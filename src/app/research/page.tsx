...
const research = () => {
  return (
    <div className=' relative h-screen'>
      ...
      <div className="relative flex flex-col lg:p-[150px]  h-screen">
      ...
      <div className=' h-[350px] w-[500px] lg:m-[90px] bg-cover' style={{backgroundImage: `url(https://images.unsplash.com/photo-1542744173-05336fcc7ad4?q=80&w=2002&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)`}} ></div>
    ...
    <div className='h-[800px] w-full bg-white lg:p-[80px] flex lg:flex-row sm:flex-col lg:justify-between sm:justify-center'>
      <div className='lg:h-[600px] lg:w-[600px] bg-cover shadow-sm' style={{backgroundImage: `url(https://images.unsplash.com/photo-1556761175-b413da4baf72?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)`}} ></div>
